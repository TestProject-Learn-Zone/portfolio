...
$(".skillProgressBar").slice(0, 6).show();
$(".skills-load-more-btn").on("click", function () {
  $(".skillProgressBar:hidden").slice(0, 2).slideDown();
  if($(".skillProgressBar:hidden").length == 0){
    $(".skills-load-more-btn").hide();
  }
})